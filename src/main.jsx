...
function App() {
  ...
  return <main className="min-h-screen bg-[#fff7ed] text-[#3b2116]">
    ...
    <a href={whatsappUrl} className="fixed bottom-6 right-6 hidden items-center gap-3 rounded-full bg-emerald-600 px-6 py-4 font-bold text-white shadow-2xl md:flex"><ShoppingCart size={20}/> Order Now</a>
  </main>;
}
